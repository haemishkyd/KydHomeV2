...
# ESP Micropython
node_c = pydot.Node("Outside Light", style="filled", fillcolor="greenyellow")
node_d = pydot.Node("Outside Temperature", style="filled",
                    fillcolor="greenyellow")
node_e = pydot.Node("Gate Light", style="filled", fillcolor="greenyellow")
node_f = pydot.Node("Gate Control", style="filled", fillcolor="greenyellow")
node_h = pydot.Node("Pool Pump", style="filled", fillcolor="greenyellow")
...
graph.add_edge(pydot.Edge(node_a, node_h))
...
graph.add_edge(pydot.Edge(node_f, node_a))
